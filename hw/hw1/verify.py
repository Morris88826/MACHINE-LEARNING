...
def verify_linear_regression(data1, data2):
    mse = np.mean((data1 - data2) ** 2)
    print("MSE: {:.3f}".format(mse))   
    if mse < 0.1:
        print("The data is verified")
    else:
        print("The data is not verified")

def verify_logistic_regression(data1, data2):
...
if __name__ == "__main__":
    ...
    verify_linear_regression(df1["pred_linear"], df2["pred_linear"])
    verify_logistic_regression(df1["pred_logistic"], df2["pred_logistic"])